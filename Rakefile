...
IRREGULAR = {'files/xmonad.desktop' => '/usr/share/xsessions/xmonad.desktop', 'files/ssh_config' => '~/.ssh/config', 'files/20-thinkpad.conf' => '/etc/X11/xorg.conf.d/20-thinkpad.conf'}
