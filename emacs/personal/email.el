(use-package mu4e-maildirs-extension :init (mu4e-maildirs-extension))
...
(use-package mu4e
  ...
  (progn
    ...
    (setq
     ...
     mu4e-attachment-dir (lambda (fname mtype)
                           (cond
     ...
     mu4e-compose-complete-ignore-address-regexp (regexp-opt
                                                  '("donotreply" "no-reply" "noreply"
                                                    "docs.google.com" "reply.github.com"
                                                    "ticket+theplant" "compute.internal"))
     ...
     smtpmail-nauth-credentials (expand-file-name "~/.authinfo.gpg")
  ...
  :bind (
         ("<f3>e" . mu4e)
         ("<f3><f3>j" . mu4e~headers-jump-to-maildir)
         ("<f3><f3>b" . mu4e-headers-search-bookmark)
